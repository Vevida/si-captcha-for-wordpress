...
<p>
 <label>';
                ...
                echo '<br />
<input id="captcha_code" name="captcha_code" class="input" type="text" value="" size="12" ' . $si_aria_required . ' style="font-size: 24px; width: 97%; padding: 3px; margin-top: 2px; margin-right: 6px; margin-bottom: 16px; border: 1px solid #e5e5e5; background: #fbfbfb;" /></label>
</p>
<br />
';
            }
...
';
            ...
            $si_html .= '<a href="#" rel="nofollow" tabindex="30" title="';
